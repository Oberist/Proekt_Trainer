...
# BASE_DIR уже указывает на папку rag, поэтому не добавляем "rag" повторно
FAISS_PATH = os.path.join(BASE_DIR, "vector_index.bin")
...
def get_index_info():
    ...
    try:
        ...
        dimension = getattr(index, 'd', 'unknown')
